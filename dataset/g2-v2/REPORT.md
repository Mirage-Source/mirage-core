# MIRAGE Honeypot Dataset — g2-v2

Generated from live capture data. Snapshot covers **17,786 sessions** across **510 unique source IPs**.

## Headline finding

**16,641 of 17,786 sessions (93.56%) executed zero commands** after authentication. The remainder (6.44%) reached the interactive shell and executed real commands — the honeypot is no longer purely a credential-stuffing sink.
...
|---|---|
| `SSH-2.0-Go` | 9,317 |
| `SSH-2.0-libssh_0.9.6` | 6,917 |
| `SSH-2.0-libssh_0.11.1` | 514 |
| `SSH-2.0-JSCH_2.28.6` | 287 |
| `SSH-2.0-PuTTY_Release_0.84` | 210 |
| `SSH-2.0-OpenSSH_10.4` | 195 |
| `SSH-2.0-<img src=x onerror="alert('you can be pwned ^_^')">` | 124 |
| `SSH-2.0-libssh2_1.11.0` | 81 |
| `SSH-2.0-libssh_0.12.0` | 56 |
...
### 3 IPs — `cat: iakk: No such file or directory` via `SSH-2.0-Go`

- **Window:** 2026-09-04 10:20 UTC (5-minute bucket)
- **IPs:** 103.20.219.5, 190.220.16.245, 220.130.176.1
- **ASN breakdown:** Diskominfo Kabupaten Humbang Hasundutan (1), Techtel LMDS Comunicaciones Interactivas S.A. (1), Chunghwa Telecom Co., Ltd. (1)
- **Country breakdown:** ID (1), AR (1), TW (1)
...
|---|---|
| UNMANAGED LTD | 1,771 |
| "Euro Crypt" EOOD | 1,560 |
| Alfahost LLC | 1,110 |
| DigitalOcean, LLC | 977 |
| LLC VASH KREDIT BANK | 784 |
| Microsoft Corporation | 680 |
| Hetzner Online GmbH | 511 |
| OVH SAS | 463 |
| TECHOFF SRV LIMITED | 384 |
| Korea Telecom | 352 |
...
- 9 of 510 source IPs could not be resolved to an ASN in this snapshot's pinned DB-IP data (coverage gap, not a classification result).
...
*Generated 2026-09-06 07:40 UTC. Dataset version: g2-v2.*