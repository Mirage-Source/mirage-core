# MIRAGE Honeypot Dataset — g2-v4

Generated from live capture data. Snapshot covers **144,443 sessions** across **2302 unique source IPs**.

## Headline finding

**138,922 of 144,443 sessions (96.18%) executed zero commands** after authentication. The remainder (3.82%) reached the interactive shell and executed real commands — the honeypot is no longer purely a credential-stuffing sink.
...
|---|---|
| `SSH-2.0-Go` | 121,526 |
| `SSH-2.0-libssh_0.9.6` | 17,779 |
| `SSH-2.0-libssh_0.11.1` | 1,390 |
| `SSH-2.0-PuTTY_Release_0.84` | 1,032 |
| `SSH-2.0-libssh_0.9.5` | 998 |
| `SSH-2.0-JSCH_2.28.6` | 478 |
| `SSH-2.0-libssh2_1.11.0` | 255 |
| `SSH-2.0-OpenSSH_10.4` | 197 |
| `SSH-2.0-OpenSSH_8.4p1 Debian-5+deb11u3` | 195 |
| `SSH-2.0-libssh_0.12.0` | 152 |
...
| ASN Name | Sessions |
|---|---|
| "Euro Crypt" EOOD | 49,440 |
| UNMANAGED LTD | 5,585 |
| OVH SAS | 5,095 |
| Hayat for Internet & communication LLC | 4,644 |
| noris network AG | 4,140 |
| Entel S.A. - EntelNet | 3,414 |
| DigitalOcean, LLC | 2,076 |
| SKYNET NETWORK LTD | 2,013 |
| TECHOFF SRV LIMITED | 1,947 |
...
- 35 of 2302 source IPs could not be resolved to an ASN in this snapshot's pinned DB-IP data (coverage gap, not a classification result).
...
*Generated 2026-09-20 08:20 UTC. Dataset version: g2-v4.*