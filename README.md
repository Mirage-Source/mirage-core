...
<!-- STATS:START -->
- **163,392 sessions** captured from **2,576 unique source IPs** (3,001 in the last 24h)
- Most repeated credential pair: `root` / `root` (709 attempts)
...
_Last updated automatically: 2026-09-25T02:31:31Z_
<!-- STATS:END -->
